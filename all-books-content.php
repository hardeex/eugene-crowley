<div class="container">
        ...
        <div class="hero-banner">
            <h1>Discover the Books of Gene Crowley Jr.</h1>
            <p>Explore profound insights and captivating narratives that challenge perceptions and inspire minds.</p>
        </div>

            <!-- Book 2 -->
            <div class="book-section row">
            <div class="col-md-4 book-cover">
                <img src="images/Paris on my mind.jpg" alt="Paris On My Mind Cover">
            </div>
            <div class="col-md-8">
                <h2 class="book-title">Paris On My Mind</h2>
                <h4 class="book-author">by Gene Crowley Jr.</h4>
        ...
        <div class="book-section row">
           ...
           <div class="col-md-8">
                <h2 class="book-title">Upside Down World</h2>
                <h4 class="book-author">by Gene Crowley Jr.</h4>
                <p class="book-edition">Format: Kindle Edition</p>
                <p class="book-description">
                    Upside Down World: The Loss of the Sacred Cosmos is an incisive look at the concept of self-awareness, instructing readers on how to find their true identity and potential. Through detailed research, it shows how to view reality and thereby move into a state of life fulfillment.
                </p>
                <p class="book-description">
            ...
            <div class="col-md-4 book-cover">
                <img src="images/upside down by eugene croley.jpg" alt="Upside Down World Cover">
            </div>
